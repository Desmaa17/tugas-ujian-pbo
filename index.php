...
<head>
     ...
     <title>website penyimpanan data siswa</title>
</head>

<body style="background:#a2cccd">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-warning bg-warning text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Penyimpanan Data Siswa SMAN 1 Alas Barat</a>
          ...
          <div class="row my-2">
               <div class="col-md">
                    <a href="addData.php" class="btn btn-primary" data-aos="fade-right" data-aos-duration="800"
                         data-aos-delay="1200"><i class="bi bi-person-plus-fill"></i>Tambah Data Siswa</a>
                    <a href="export.php" target="_blank" class="btn btn-success ms-1" data-aos="fade-left"
                         data-aos-duration="1000" data-aos-delay="1600"><i
                              class="bi bi-file-earmark-spreadsheet-fill"></i>Expor Pada Excel</a>
               </div>
          </div>
     ...
     gsap.to('.data_siswa', {
          duration: 1,
          delay: 0.6,
          text: 'Data Siswa SMAN 1 Alas Barat'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
